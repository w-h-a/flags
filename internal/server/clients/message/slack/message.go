...
func (c *client) convert(diff message.Diff) slackMessage {
...
func (c *client) convertDeleted(diff message.Diff) []attachment {
...
func (c *client) convertAdded(diff message.Diff) []attachment {
	attachments := []attachment{}
...
func (c *client) convertUpdated(diff message.Diff) []attachment {
	attachments := []attachment{}
